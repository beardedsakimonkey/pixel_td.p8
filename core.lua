...
tower_cfg = parse_tbl[[
dmg=3.0,range=32,buy=40,upg=50
dmg=2.8,range=28,buy=40,upg=50
dmg=2.8,range=25,buy=40,upg=50

dmg=4.0,range=34,upg=55
dmg=3.8,range=30,upg=55
dmg=3.8,range=27,upg=55

dmg=5.0,range=36,upg=70
dmg=4.8,range=32,upg=70
dmg=4.8,range=29,upg=70
