...
waves = {
    ...
    {hp=15, speed=0.25, gold=4, type=ENMY.circ, boss_hp=1, boss_gold=10},
    ...
    {hp=24, speed=0.25, gold=4, type=ENMY.circ, boss_hp=1, boss_gold=10},
    ...
    {hp=33, speed=0.25, gold=4, type=ENMY.circ, boss_hp=1, boss_gold=10},
    ...
    {hp=42, speed=0.25, gold=4, type=ENMY.circ, boss_hp=1, boss_gold=10},
    ...
    {hp=52, speed=0.25, gold=4, type=ENMY.circ, boss_hp=1, boss_gold=10},
}
tower_cfg = {
    -- level 1
